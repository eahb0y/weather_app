...
class GetCurrentWeatherModal {
  GetCurrentWeatherModal({
    this.coord,
    this.weather,
    this.base,
    this.main,
  ...
  GetCurrentWeatherModal.fromJson(dynamic json) {
  ...
  CurrentWeatherResponseEntity toEntity() {
    List<WeatherEntity> weatherEntity = [];
    weather?.forEach((wea) {
      weatherEntity.add(WeatherEntity(
        description: wea.description,
        main: wea.main,
      ));
    });
    return CurrentWeatherResponseEntity(
